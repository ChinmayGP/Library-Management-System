# -*- coding: utf-8 -*-
"""
Created on Sat Apr 16 22:20:58 2022
...
#from backtologin import back2login
...
def addBook(): 
    ...
    quitBtn = Button(root,text="Back",bg='#f7f1e3', fg='black', command=lambda:[root.destroy(),adminlogin()])
